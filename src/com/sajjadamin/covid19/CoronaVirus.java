    ...
    public String getJsonStatistics() throws IOException{
        ...
        for (int i = 0; i < tbody.getElementsByTag("tr").size(); i++) {
            ...
            String country,total_cases,new_cases,total_deaths,new_deaths,total_recovered,active_cases,serious_cases;
                ...
                if(total_cases.equals("")) total_cases = "0";
                if(new_cases.equals("")) new_cases = "0";
                if(total_deaths.equals("")) total_deaths = "0";
                if(new_deaths.equals("")) new_deaths = "0";
                if(total_recovered.equals("")) total_recovered = "0";
                if(active_cases.equals("")) active_cases = "0";
                if(serious_cases.equals("")) serious_cases = "0";
